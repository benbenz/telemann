...
k_comp_oscs_tuning = CompositingKey.OSCS_COMPOSITING_TUNING.value
k_comp_oscs_tuning_glue = CompositingKey.OSCS_COMPOSITING_TUNING_GLUE.value
k_comp_oscs_tuning_afterward_oct = CompositingKey.OSCS_COMPOSITING_TUNING_AFTERWARD_OCT.value
k_comp_oscs_tuning_afterward_pitch = CompositingKey.OSCS_COMPOSITING_TUNING_AFTERWARD_PITCH.value
