# Generated by Django 5.0 on 2024-02-19 18:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameters', models.JSONField(blank=True, default=None, help_text='Parameters for this specific soundbite (source(if+processor parameters)', null=True)),
                ('last_modified', models.DateTimeField(default=None, help_text='the date/time the file was modified', null=True)),
                ('record_date', models.DateTimeField(auto_now_add=True, help_text='the date/time the file was entered in the database')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('files', 'Files'), ('recording', 'Recording'), ('voice', 'Voice'), ('instrument', 'Instrument')], default='instrument', help_text='Type of source', max_length=16)),
                ...
                ('name', models.CharField(help_text="The name of the sound source: 'SynthMaster', 'Diva', etc.", max_length=64)),
                ('description', models.CharField(default=None, help_text='A short description', max_length=256, null=True)),
                ...
                ('midi_bank_num', models.IntegerField(blank=True, choices=sounds.models.choice_midi_bank, default=None, help_text='The MIDI bank maximum value', null=True)),
                ('midi_bank_use_lsb', models.BooleanField(blank=True, default=None, help_text='If the Bank LSB is used or not', null=True)),
                ...
                ('parameters', models.JSONField(blank=True, default=None, help_text='Extra Parameters for this source', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='SoundTone',
            fields=[
                ...
                ('midi_bank_msb', models.IntegerField(blank=True, choices=sounds.models.choice_midi_bank, default=None, help_text='The MIDI bank MSB of the sound', null=True)),
                ('midi_bank_lsb', models.IntegerField(blank=True, choices=sounds.models.choice_midi_bank, default=None, help_text='The MIDI bank LSB of the sound', null=True)),
        ...
        migrations.AddField(
            model_name='soundtone',
            name='tags',
            field=models.ManyToManyField(blank=True, help_text='Tags associated with the sound', related_name='sounds', to='tags.tag'),
        ),
        migrations.AddField(
            model_name='soundbite',
            name='source',
        ...
        migrations.AddConstraint(
            model_name='soundtone',
            constraint=models.UniqueConstraint(fields=('source', 'midi_bank_msb', 'midi_bank_lsb', 'midi_program'), name='source_bank_program_is_unique'),
        ),
        migrations.AddIndex(
            model_name='soundbite',
