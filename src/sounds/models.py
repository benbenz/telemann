...
class SoundTone(models.Model):
    ...
    rec_duration  = models.FloatField(null=True,default=None,blank=True,help_text="A recommended duration in seconds for this sound",verbose_name='Recommended Duration')
