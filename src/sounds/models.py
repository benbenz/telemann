...
class SoundTone(models.Model):
    ...
    description_tech = models.TextField(max_length=512,null=True,default=None,blank=True,help_text="Technical description automatically generated by the system")
    rec_duration  = models.FloatField(null=True,default=None,blank=True,help_text="A recommended duration in seconds for this sound")
    rec_midi_range = models.PositiveSmallIntegerField(choices=choice_midi_range,null=True,default=None,blank=True,help_text="A recommended MIDI range for this sound")
